  ...
  return (
    <Layout>
      <div className="container">
        ...
        <p>
        <a className="btn btn-primary btn-lg" href={host + `/company/${companyData[0].local_organization_id.id}`} role="button">More Info</a>
        <a className="btn btn-primary btn-lg" href={host + `/company/${companyData[0].local_organization_id.id}`} role="button">General</a>
        <a className="btn btn-primary btn-lg" href={host + `/api/company/highlights/${companyData[0].local_organization_id.id}`} role="button">Highlights</a>
        <a className="btn btn-primary btn-lg" href={host + `/api/company/basics/${companyData[0].local_organization_id.id}`} role="button">Relations</a>
        </p>
      </div>
